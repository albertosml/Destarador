 ...
 * @author alber
 */
public class AniadirPalet extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        titulo.setText("Datos del palet a añadir");
        ...
        if(!name.isEmpty()) { // Compruebo nombre
            ...
            if(p.matches("[0-9]+[.][0-9]+") || p.matches("[0-9]+")) {  // Compruebo peso de la caja
               OperacionesBD o = new OperacionesBD();
                try {
                    String s = o.addPalet(name,p,ruta.getText());
                    if(s.contains("error")) JOptionPane.showMessageDialog(rootPane,"No está conectado a la base de datos");
                    else JOptionPane.showMessageDialog(rootPane,"Palet añadido con éxito");
                } catch (SQLException | ClassNotFoundException ex) {
                    Logger.getLogger(AniadirPalet.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            else JOptionPane.showMessageDialog(rootPane,"El peso puede ser un número entero (135) ó decimal (135.46)");
        }
        else JOptionPane.showMessageDialog(rootPane,"Introduzca un nombre para el palet");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AniadirPalet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AniadirPalet().setVisible(true);
            }
        });
    }
